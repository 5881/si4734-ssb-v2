...
работает только с si4735 и si4732, он работает и с si4734 которая в 
5 раз дешевле.
...
!!!Добавлена функция динамического шага перестройки, в зависимости от 
скорости вращения энкодера, настраивать ssb теперь удобно и с шагом 10Гц.
